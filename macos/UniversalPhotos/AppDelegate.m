...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"UniversalPhotos"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit UniversalPhotos" action:@selector(terminate:) keyEquivalent:@"q"];
